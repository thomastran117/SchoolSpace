          ...
          <aside className="col-lg-3">
            ...
            >
              <div className="card-body p-3">
                <nav className="nav nav-pills flex-column small" aria-label="Terms sections">
                  {sections.map((s) => (
              ...
              <div className="card-body p-4 p-md-5">
                <Section id="introduction" title="Introduction">
                  <p>
                    ...
                    {" "}
                    <strong>{companyName}</strong>'s websites, applications, and services
                ...
                <Section id="acceptance" title="Acceptance of Terms">
                  <p>
                    ...
                    you can form a binding contract with {companyName}, and you agree to comply
                ...
                <Section id="changes" title="Changes to the Terms">
                  <p>
                    ...
                    notified by updating the date above and, where appropriate, by additional
                    notice within the Services. Continued use after changes constitutes
                ...
                <Section id="eligibility" title="Eligibility & Accounts">
                  <ul>
                    ...
                    <li>
                      Provide accurate information and keep it up‑to‑date; we may suspend or
                      terminate accounts with inaccurate information.
                    </li>
                  </ul>
                </Section>
                ...
                <Section id="use" title="Permitted & Prohibited Use">
                  ...
                  <ul>
                    ...
                    <li>Introduce malware, disrupt servers, or attempt unauthorized access.</li>
                    <li>Scrape or harvest data except as explicitly permitted.</li>
                    <li>Use the Services for unlawful, harmful, or abusive activities.</li>
                  </ul>
                </Section>

                <Section id="content" title="User Content & IP">
                  <p>
                    You retain ownership of content you submit ("User Content"). You grant
                    {" "}
                    {companyName} a worldwide, non‑exclusive, royalty‑free license to host,
                    store, reproduce, modify, and display User Content for the purpose of
                    operating and improving the Services. See our Privacy section for how we
                    handle personal data.
                  </p>
                </Section>

                <Section id="subscriptions" title="Subscriptions, Billing & Refunds">
                  <ul>
                    <li>Paid features may be offered on a subscription basis.</li>
                    <li>
                      Fees, billing cycles, and cancellation terms will be disclosed at
                      purchase. Unless required by law, fees are non‑refundable.
                    </li>
                    <li>We may change pricing with reasonable prior notice to you.</li>
                  </ul>
                </Section>

                <Section id="privacy" title="Privacy & Data">
                  <p>
                    Our collection and use of personal information are described in our Privacy
                    Policy. By using the Services, you consent to such processing as described
                ...
                <Section id="security" title="Security">
                  <p>
                    We use commercially reasonable safeguards to protect the Services; however,
                    no method of transmission or storage is completely secure. You are
                    responsible for configuring your information technology and using your own
                    virus protection.
                  </p>
                </Section>
                ...
                <Section id="thirdparty" title="Third‑Party Services">
                  <p>
                    The Services may link to or integrate with third‑party websites, products,
                    or services that are not owned or controlled by {companyName}. We are not
                ...
                <Section id="termination" title="Termination">
                  <p>
                    ...
                    without cause or notice, including if you breach these Terms. Upon
                    termination, certain provisions will survive, including ownership, warranty
                ...
                <Section id="disclaimers" title="Disclaimers">
                  ...
                  <p>
                    {companyName} does not warrant that the Services will be uninterrupted,
                ...
                <Section id="limitation" title="Limitation of Liability">
                  <p>
                    ...
                    INTANGIBLE LOSSES, RESULTING FROM YOUR ACCESS TO OR USE OF THE SERVICES.
                  </p>
                </Section>
                ...
                <Section id="indemnity" title="Indemnification">
                  <p>
                    ...
                    out of or in any way connected with your use of the Services or your breach
                    of these Terms.
                  </p>
                </Section>
                ...
                <Section id="governinglaw" title="Governing Law & Disputes">
                  <p>
                    These Terms are governed by the laws of your principal place of business for
                    {companyName}, without regard to its conflicts of laws rules. Disputes will
                    be resolved in the courts located in that jurisdiction unless otherwise
                ...
                <Section id="misc" title="Miscellaneous">
                  <ul>
                    <li>
                      ...
                      agreement between you and {companyName} regarding the Services.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>No Waiver.</strong> Failure to enforce any right will not be
                ...
                <Section id="contact" title="Contact">
                  <p>
                    ...
                    <a href={`mailto:${contactEmail}`}>{contactEmail}</a> or use the button
                    below.
                  </p>
                ...
                <div className="d-flex flex-wrap gap-2 mt-4">
                  <button className="btn btn-outline-secondary" onClick={() => window.print()}>
                    <i className="bi bi-printer me-2" aria-hidden="true"></i>Print
                  </button>
            ...
            <div className="modal-body">
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="mb-3">
                  ...
                  <input id="contactEmail" type="email" className="form-control" placeholder="you@example.com" required />
                </div>
                <div className="mb-3">
                  <label htmlFor="contactMsg" className="form-label">Message</label>
                  <textarea id="contactMsg" className="form-control" rows={4} placeholder="How can we help?" required />
                </div>
                <div className="form-text">This demo form does not submit anywhere.</div>
              </form>
            </div>
