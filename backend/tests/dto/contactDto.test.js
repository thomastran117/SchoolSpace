...
const contactSchema_1 = require("../../src/dto/contactSchema");
describe("Contact Zod DTO Schemas", () => {
  describe("CreateContactSchema", () => {
    it("accepts valid input and normalizes email + captcha", () => {
      ...
      const parsed = contactSchema_1.CreateContactSchema.parse(input);
    ...
    it("rejects invalid email", () => {
      const res = contactSchema_1.CreateContactSchema.safeParse({
        email: "not-an-email",
        topic: "Help me",
        message: "This is a valid message.",
        captcha: "token",
    ...
    it("rejects topic shorter than 4 or longer than 100", () => {
      const tooShort = contactSchema_1.CreateContactSchema.safeParse({
        email: "a@b.com",
        topic: "abc",
        message: "This is a valid message.",
        captcha: "token",
      ...
      const tooLong = contactSchema_1.CreateContactSchema.safeParse({
        email: "a@b.com",
        topic: "a".repeat(101),
        message: "This is a valid message.",
        captcha: "token",
    ...
    it("rejects empty captcha, and captcha longer than 4000", () => {
      const empty = contactSchema_1.CreateContactSchema.safeParse({
        email: "a@b.com",
        topic: "Help me",
        message: "This is a valid message.",
        captcha: "",
  ...
  describe("UpdateContactSchema", () => {
    it("allows partial fields (empty object is valid schema-wise)", () => {
      const res = contactSchema_1.UpdateContactSchema.safeParse({});
    ...
    it("normalizes provided email", () => {
      const res = contactSchema_1.UpdateContactSchema.parse({
        email: "  TEST@Example.COM  ",
      });
